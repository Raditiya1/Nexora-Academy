        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">
                Nexora<span className="text-primary-400">Academy</span>
              </span>
            </Link>
            <p className="text-secondary-300 mb-6 leading-relaxed">
              Empowering learners worldwide with industry-focused online courses. 
              Build real-world skills and advance your career with expert mentors.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-secondary-300 hover:text-primary-400 transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {categories.map((category) => (
                <li key={category}>
                  <Link href="/courses" className="text-secondary-300 hover:text-primary-400 transition-colors">
                    {category}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-secondary-300">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>hello@nexoraacademy.com</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-primary-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-secondary-400 text-sm">
              © {currentYear} Nexora Academy. All rights reserved.
            </p>
